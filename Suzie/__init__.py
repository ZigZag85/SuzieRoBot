# This file is part of Suzie (Telegram Bot)
...
from Suzie.config import get_bool_key, get_int_key, get_list_key, get_str_key
from Suzie.utils.logger import log
from Suzie.versions import Suzie_VERSION

log.info("----------------------")
log.info("|      Suize      |")
log.info("----------------------")
log.info("Version: " + Suzie_VERSION)
