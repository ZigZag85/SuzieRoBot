...
import SuzieRoBot.modules.sql.global_bans_sql as gban_sql
import SuzieRoBot.modules.sql.users_sql as user_sql
from SuzieRoBot import DEV_USERS, OWNER_ID, dispatcher
