from SuzieRoBot import pbot as app
from SuzieRoBot.pyrogramee.errors import capture_err
from SuzieRoBot.pyrogramee.json_prettify import json_prettify
from SuzieRoBot.pyrogramee.fetch import fetch
