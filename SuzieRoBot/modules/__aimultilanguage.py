...
# ported to Suzie @Mr_dark_prince
from SuzieRoBot import OWNER_ID, BOT_ID
from SuzieRoBot import telethn as tbot
import SuzieRoBot.modules.sql.aihelp_sql as sql
import SuzieRoBot.modules.sql.chatbot_sql as ly
